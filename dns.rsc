/ip dns static
add address=158.101.141.184 disabled=yes name=www.googleapis.com
add address=158.101.141.184 disabled=yes name=oauth2.googleapis.com
add forward-to=198.18.0.1 name=upgrade.mikrotik.com type=FWD
add address=104.22.34.211 comment=Linux regexp=\
    "*.\\.(workers|terrance)\\.(dev|work)\$"
...
add comment=Get forward-to=198.18.0.1 regexp=\
    ".*(\\.)\?(medium|wikipedia)\\.(com|org)" type=FWD
...
add address=2606:4700:d0::a29f:c001 comment="Cloudflare Warp" name=\
    engage.cloudflareclient.com type=AAAA
